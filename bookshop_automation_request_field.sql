...
CREATE TABLE `request_field` (
  ...
  `request_book_title` varchar(40) DEFAULT NULL,
  `request_book_author` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`s_no`)
...
INSERT INTO `request_field` VALUES (3,'04/20/22  11:07:22','madhavi','9700604368','ramayanam','valmiki');
